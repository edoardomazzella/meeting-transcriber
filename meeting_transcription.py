...
class MeetingMinutesGenerator:
    ...
    def _build_prompt(transcript):
        return (
            ...
            "Write in the main language used in the transcript. If the meeting is a roundtable "
            "discussion, try to structure the minutes as a roundtable-style summary, grouping "
            "contributions by speaker/participant when identifiable and keeping the flow of the "
            "discussion clear. Include: title, date if explicitly available, participants if "
            "identifiable, concise summary, discussion points, decisions, and an action-items "
            "table with owner and due date. Clearly mark unknown owners or dates as 'Not specified'. "
            "Do not invent facts, decisions, names, or deadlines. Return only the Markdown "
            "document.\n\n"
            "<transcript>\n"
            f"{transcript}\n"
            "</transcript>"
